...
- Bump **jackson-databind** from 2.20.1 to 2.22.0.
...
- Static field `ResultModule.MODULE_VERSION` has been made `private`.
- Class `ResultBuilder` is no longer `public`.
...
- Bump **jackson-databind** from 2.19.0 to 2.19.1.
...
[1.0.3.0]: https://github.com/LeakyAbstractions/result-jackson/releases/tag/1.0.3.0
[1.1.0.0]: https://github.com/LeakyAbstractions/result-jackson/releases/tag/1.1.0.0
